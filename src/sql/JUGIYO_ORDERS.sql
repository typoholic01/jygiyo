...
CREATE TABLE JUGIYO_ORDERS(
	...
	FOREIGN KEY(seqFoodDetail) REFERENCES JUGIYO_FOOD_Details(seqFoodDetail) ON UPDATE CASCADE ON DELETE CASCADE,
	FOREIGN KEY(userId) REFERENCES JUGIYO_users(userId) ON UPDATE CASCADE ON DELETE CASCADE
